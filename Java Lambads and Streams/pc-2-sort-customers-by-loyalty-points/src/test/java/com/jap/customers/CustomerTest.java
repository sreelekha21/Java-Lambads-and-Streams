...
public class CustomerTest {
    ...
    @Before
    public void setUp(){
        customer =new Customer(4344,"Rhonda","Female",false,"Austin",120);
    ...
    public void givenCustomerObjectReturnDetails(){
        String expected = "Customer{customerId=4344, customerName='Rhonda', customerGender='Female', isSeniorCitizen=false, city='Austin', loyaltyPoints=120}";
